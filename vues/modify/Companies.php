...
<body>
    ...
    <main>
        ...
        <div class="create-company-container">
            <h1>Modifier cette entreprise</h1>
    ...
    <script src="/assets/js/manage/companies.js" defer></script> <!-- C'est le même fichier JS que pour le formulaire de création d'entreprises -->
