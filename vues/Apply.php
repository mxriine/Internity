    ...
    <section class="application-form">
            ...
            <!-- Nom et Prénom -->
                ...
                <div class="form-group">
                    ...
                    <textarea id="message" name="message" rows="5" placeholder="Ajoutez un message si nécessaire"></textarea>
        ...
        <section class="card-section">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi ut gravida quam. Aliquam quis cursus tortor.                         Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi ut gravida quam. Aliquam quis cursus tortor.
